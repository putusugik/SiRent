 ...
 */
public class Fragment_HistoriUser extends Fragment {

    SharedPref sharedPref;
    private Histori_UserAdapter histori_userAdapter;
    JSONParser jsonParser = new JSONParser();
    private static String url_histori = "http://sirent.esy.es/select_historiuser.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_histori_user, container, false);
        sharedPref = new SharedPref(getActivity().getApplicationContext());
        id = sharedPref.getUserID();
        lv = (ListView)v.findViewById(R.id.listhistori);
        new loadHistori().execute();

        return v;
    }

    private class loadHistori extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject obj = jsonParser.makeHttpRequest(url_histori, "GET", params);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            if (histori_userAdapter !=null){
                histori_userAdapter.notifyDataSetChanged();
                return;
            }
            histori_userAdapter = new Histori_UserAdapter(getActivity(), booklist);
            lv.setAdapter(histori_userAdapter);
        }
    }
 }
