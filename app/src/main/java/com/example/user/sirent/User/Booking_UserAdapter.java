...
class Booking_UserAdapter extends BaseAdapter implements Filterable {
    ...
    public Booking_UserAdapter(Activity a, ArrayList<HashMap<String,String>> d){
        activity = a;
        data = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            ...
            t_IDkend.setText(booking.get(Fragment_StatusBookingUser.TAG_ID));
            t_kendu.setText(booking.get(Fragment_StatusBookingUser.TAG_KENDARAAN));
            t_nplatu.setText(booking.get(Fragment_StatusBookingUser.TAG_PLAT));
            t_sewau.setText(booking.get(Fragment_StatusBookingUser.TGL_SEWA));
            t_kemu.setText(booking.get(Fragment_StatusBookingUser.TAG_KEMBALI));
            t_stsu.setText(booking.get(Fragment_StatusBookingUser.TAG_STATUSBOOK));
