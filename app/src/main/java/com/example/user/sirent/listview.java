...
public class listview extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String UPLOAD_URL = "localhost/sirent/upload.php";
    public static final String UPLOAD_KEY = "gambar";
    ...
    private void uploadImage() {
        class UploadImage extends AsyncTask<Bitmap, Void, String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(listview.this, "Mengunggah Gambar", "Mohon tunggu...", true, true);
            }
