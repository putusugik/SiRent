...
public class profil_user_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_namadep.setEnabled(false);
        edit_namabel.setEnabled(false);
        edit_tempatlahir.setEnabled(false);
        edit_tgllahir.setEnabled(false);
        edit_nohp.setEnabled(false);
        edit_alamat.setEnabled(false);
    ...
    class getProfilDetail extends AsyncTask <String, String, List<String>>{
        ...
        protected void onPostExecute(List<String> result) {
            ...
            imageLoader.DisplayImage(result.get(8), profil_user_admin.this.image);
    ...
    class updateUser extends AsyncTask<String, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(profil_user_admin.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try{
                ...
                if (sukses == 1){
                    profil_user_admin.this.params.put("id",""+id);
                    Intent i = new Intent(profil_user_admin.this, Dashboard_Admin.class);
